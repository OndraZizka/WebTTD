 ...
 * @author Ondrej Zizka
 */
public class ReadersAndModifierSynchronizerStarving implements ReadersAndModifiersSynchronizer {

  private static final Logger log = Logger.getLogger( ReadersAndModifierSynchronizerStarving.class.getName() );
